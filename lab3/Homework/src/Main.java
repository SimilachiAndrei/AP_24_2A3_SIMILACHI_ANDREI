...
public class Main {
    public static void main(String[] args) {
        ...
        Statue statue = new Statue("Stefan cel Mare");
        ...
        TimeInterval timeInterval2 = new TimeInterval(LocalTime.of(10, 0), LocalTime.MAX);
        timetable2.put(LocalDate.now(),timeInterval2);
        statue.setTimetable(timetable2);
        ...
        System.out.println(travelPlan.visitAttraction(church));
